...
var JumpToManager = /** @class */ (function () {
    function JumpToManager(game, settings) {
        ...
        var entries = __spreadArray(__spreadArray([], ((_a = settings === null || settings === void 0 ? void 0 : settings.topEntries) !== null && _a !== void 0 ? _a : []), true), ((_b = settings === null || settings === void 0 ? void 0 : settings.playersEntries) !== null && _b !== void 0 ? _b : this.createEntries(Object.values(game.gamedatas.players), game)), true);
    ...
    JumpToManager.prototype.createEntries = function (players,game) {
        var orderedPlayers = game.gamedatas.playersorder;
        return orderedPlayers.map(function (player) { return new JumpToEntry(game.getPlayerName(player), "player-table-".concat(player), {
            'color': '#' + game.getPlayerColor(player),
            'colorback': game.gamedatas.players[Number(player)].color_back ? '#' + game.gamedatas.players[Number(player)].color_back : null,
            'id': player,
        }); });
    };
